        ...
        <div class=" col-md-9">
            <div class="row">
                <div class="form-group col-md-4">
                    ...
                    <input required required type="text" class="form-control" id="first_name" placeholder="Juan" name="first_name_v[]">
                </div>
                <div class="form-group col-md-4">
                    <label for="middle_name">Middle Name</label>
                    <input required required type="text" class="form-control" id="middle_name" placeholder="Ignacio" name="middle_name_v[]">
                </div>
                <div class="form-group col-md-4">
                    <label for="last_name">Last Name</label>
                    <input required required type="text" class="form-control" id="last_name" placeholder="De La Cruz" name="last_name_v[]">
                </div>
            </div>
            <div class="row ">
                <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-2">
                    ...
                    <input type="text" class="form-control" id="postal_code" placeholder="1007" name="postal_code_client_v[]">
                </div>
            </div>
            <!--            <div class="row ">
                        </div>-->
            ...
            <div class="row">
                <div class="form-group col-md-4">
                    ...
                    <span><input type="radio" name="sex_v[]"  value="Male" checked="checked" /> Male</span>   <span style="padding-left: 20px"><input type="radio" name="sex_v[]"  value="Female" /> Female</span>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-md-4 hidden">
                    <label for="contact_type">Contact Type</label>
                    <input required required type="text" class="form-control" value="Mobile" id="contact" placeholder="" name="contact_type_v[]">

                </div>
                <div class="form-group col-md-4">
                    <label for="contact">Contact</label>
                    <input required required type="text" class="form-control" id="contact" placeholder="+631234567890" name="contact_v[]">
                </div>
            </div>
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <input required required type="text" class="form-control" id="occupation" placeholder="Factory worker" name="occupation_v[]">
