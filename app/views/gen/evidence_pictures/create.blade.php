<div >
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="width" placeholder="fraptiousday!" name="owner">
          
            <label for="date_taken">Date Taken</label>
            <input type="date" class="form-control" id="date_taken" placeholder="fraptiousday!" name="date_taken">
